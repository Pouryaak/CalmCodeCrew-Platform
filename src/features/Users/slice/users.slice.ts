...
import {
  ...
  getOneUser,
  updateUser,
} from '../services/users.service'; // Update with your actual path
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchAllUsers.rejected, (state, action) =>
        setFailed(state, action, 'Failed to load users'),
      )
      ...
      .addCase(fetchUserById.rejected, (state, action) =>
        setFailed(state, action, 'Failed to load user'),
      )
      ...
      .addCase(modifyUser.rejected, (state, action) =>
        setFailed(state, action, 'Failed to update user'),
      )
      ...
      .addCase(removeUser.rejected, (state, action) =>
        setFailed(state, action, 'Failed to delete user'),
      );
  },
});
